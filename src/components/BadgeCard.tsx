      ...
      <div className="p-4 space-y-2">
        ...
        {showActions && (
          <div className="flex items-center justify-end gap-1 mt-2 pt-2 border-t border-base-300/30 flex-wrap">
            ...
            {onEdit && (
              <div className="tooltip tooltip-top" data-tip="Edit in Forge">
                <button className="btn btn-xs btn-ghost" onClick={() => onEdit(badge)}>
            ...
            {onDelete && (
              <div className="tooltip tooltip-top" data-tip="Delete from My Badges">
                <button className="btn btn-xs btn-ghost text-error" onClick={() => onDelete(badge)}>
